...
const MainForm = () => {
  ...
  return (
    <div className='max-w-5xl lg:py-10 mx-auto '>
      <div className="flex flex-col lg:flex-row lg:gap-10 justify-center items-center   rounded-3xl  lg:pr-10 bg-white shadow-2xl  min-h-screen">

        <div style={{ background: `radial-gradient(circle, rgba(112,196,206,1) 0%, rgba(17,47,109,1) 100%)` }}
          className="w-full h-full text-white gap-5 lg:w-3/4   bg-[#112f6d] lg:rounded-3xl   flex flex-col lg:px-10  p-10 lg:p-0 lg:min-h-screen  ">
